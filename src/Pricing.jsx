...
function Pricing() {
    return(
        <div className="flex flex-col z-20 mb-10">
            <div className="flex flex-col justify-center items-center gap-3">
                <p className="md:text-5xl font-extrabold text-blue-950">Pricing Plans</p>
                <div className="flex flex-col justify-center items-center gap-0.5 text-black">
                    <p>Choose a plan that fits your needs.</p>
                    <p>Start free and upgrade anytime - no credit card required</p>
                </div>
            </div>

            <div className="flex md:flex-row justify-center items-center gap-10 pl-3 mt-10 ">
                <div className="flex flex-col gap-3 pt-4 items-center w-[250px] h-[320px] bg-white z-10 shadow-2xl shadow-gray-700 rounded-md ">
                    ...
                    <p className="bg-green-500 p-1.5 px-10 font-bold text-white rounded-md hover:cursor-pointer hover:scale-105 transition-transform duration-300">Start for Free</p>
                </div>
                ...
                <div className="flex flex-col gap-3 pt-4 items-center w-[250px] h-[320px] bg-white z-10 shadow-2xl shadow-gray-700 rounded-md ">
                    ...
                    <p className="bg-blue-700 p-1.5 px-10 font-bold text-white rounded-md hover:cursor-pointer hover:scale-105 transition-transform duration-300">Upgrade to Basic</p>
                </div>
                ...
                <div className="flex flex-col gap-3 pt-4 items-center w-[250px] h-[320px] bg-white z-10 shadow-2xl shadow-gray-700 rounded-md ">
                    ...
                    <p className="bg-purple-700 p-1.5 px-10 font-bold text-white rounded-md hover:cursor-pointer hover:scale-105 transition-transform duration-300">Start for Free</p>
                </div>
            </div>
        </div>
    );
